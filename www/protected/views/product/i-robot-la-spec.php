...
<div class="pro-m">
	...
	<div class="pro-m-t1">
    	<a href="<?php echo $this->url("Product","IRobotLASpec");?>" class="c4 hover"></a>
        <a href="<?php echo $this->url("Product","IRobotSCSpec");?>" class="c5"></a>
        <a href="<?php echo $this->url("Product","IRobotBOSpec");?>"class="c6"></a>
    </div>
    <div class="d3" style="top:145px; left:489px;"><h3>i-ROBOT-LA</h3></div>
    <div style="bottom:140px; left:90px;"><img src="<?php echo $this->url("img/robot-la-s.png");?>" width="250"/></div>
	<div style="top:220px;left:510px;"><img src="<?php echo $this->url("img/la-table.png");?>"/></div>
    <dl class="pro-down">
