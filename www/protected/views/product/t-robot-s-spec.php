...
<div class="pro-m">
    ...
    <div class="pro-m-t1">
        ...
        <a href="<?php echo $this->url("Product","TRobotSSpec");?>" class="c3 hover"></a>
    </div>
    <div class="d3" style="top:145px; left:489px;"><h3>i-ROBOT-S</h3></div>
    <div style="bottom:140px; left:90px;"><img src="<?php echo $this->url("img/robot-s.png");?>" width="250"/></div>
	<div style="top:220px;left:510px;"><img src="<?php echo $this->url("img/s-table.png");?>"/></div>
    <dl class="pro-down">
