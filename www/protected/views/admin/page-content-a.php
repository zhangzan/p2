...
<div class="bg2">
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td>
	            <textarea type="hidden" id="content" name="content"  style="display:none" ><?php if($act=="edit"){echo $page_content['content'];}?></textarea>
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="status" id="status" <?php echo $page_content['status']==1?'':'checked="checked"';?> />
			</td>
		</tr>
		<tr>
			<td colspan="2">
