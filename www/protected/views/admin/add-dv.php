...
<div class="bg2">
	...
	<form id="form1" name="form1" action="<?php echo $this->url('Admin', 'UploadDv', array('act'=>'add'));?>" method="post" enctype="multipart/form-data">
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<th width="85px">文件</th>
			<td>
				<input type="file" name="file" id="file" style="height:20px;" />
				<font color="red"><b>* (.flv 格式 , 大小不能超过8M(服务器限制))</b></font>
			</td>
		</tr>
		<tr>
			<th width="85px">标题</th>
