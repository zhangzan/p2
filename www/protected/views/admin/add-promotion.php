...
$(document).ready(function(){
	$("#btn_add_promotion").click(function(){
		...
		kajax("AjaxAdmin","AddPromotion",{title:title,
							content:content,
							level:level,
...
<div class="bg2">
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td>
				<textarea name="promotion_content" id="promotion_content" style="width:650px;height:100px;"></textarea>
				<font color="red"><b>*</b></font>
			</td>
		</tr>
		<tr>
